...
ActiveRecord::Schema.define(version: 20171212142040) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "assemblings", force: :cascade do |t|
    t.integer "percent"
  ...
  create_table "materials", force: :cascade do |t|
    t.string "name"
    t.float "climate_impact"
    t.float "water_impact"
    t.float "air_impact"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "climate_notation"
    t.integer "air_notation"
    t.integer "water_notation"
  end
