...
angora = Material.create!(name: 'angora', climate_impact: -3.500, water_impact: 0.220, air_impact: 270.000)
# , climate_impact: , water_impact: , air_impact: )
cachemire = Material.create!(name: 'cachemire', climate_impact: 270.000, water_impact: 100.049, air_impact: 670.000)
# , climate_impact: , water_impact: , air_impact: )
chanvre = Material.create!(name: 'chanvre', climate_impact: 0.430, water_impact: 0.072, air_impact: 15.000)
# , climate_impact: , water_impact: , air_impact: )
coton = Material.create!(name: 'coton', climate_impact: 1.100, water_impact: 100.110, air_impact: 7.000)
jute = Material.create!(name: 'jute', climate_impact: 0.970, water_impact: 0.055, air_impact: 7.100)
# , climate_impact: , water_impact: , air_impact: )
laine_de_chameau = Material.create!(name: 'laine de chameau', climate_impact: 36.000, water_impact: 0.037, air_impact: 170.000)
# , climate_impact: , water_impact: , air_impact: )
...
laine_de_mouton = Material.create!(name: 'laine de mouton', climate_impact: 4.700, water_impact: 0.700, air_impact: 17.000)
# , climate_impact: , water_impact: , air_impact: )
lin = Material.create!(name: 'lin (étoupe)', climate_impact: 1.300, water_impact: 0.041, air_impact: 10.000)
# , climate_impact: , water_impact: , air_impact: )
lin2 = Material.create!(name: 'lin (filasse)', climate_impact: 0.870, water_impact: 0.088, air_impact: 11.000)
# , climate_impact: , water_impact: , air_impact: )
soie = Material.create!(name: 'soie', climate_impact: 1.700, water_impact: 0.055, air_impact: 48.000)
# , climate_impact: , water_impact: , air_impact: )
polypropylene = Material.create!(name: 'bi-composant polypropylène/polyamide', climate_impact: 90.790, water_impact: 0.016, air_impact: 3.300)
# , climate_impact: , water_impact: , air_impact: )
acrylique = Material.create!(name: "acrylique", climate_impact: 1.800, water_impact: 0.017, air_impact: 14.000)
# , climate_impact: , water_impact: , air_impact: )
aramide = Material.create!(name: 'aramide', climate_impact: 2.200, water_impact: 0.012, air_impact: 7.900)
# , climate_impact: , water_impact: , air_impact: )
polyamide = Material.create!(name: "polyamide 66", climate_impact: 1.300, water_impact: 0.016, air_impact: 5.000)
# , climate_impact: , water_impact: , air_impact: )
pokyester = Material.create!(name: 'polyester', climate_impact: 1.300, water_impact: 0.026, air_impact: 5.800)
# , climate_impact: , water_impact: , air_impact: )
polyethykene = Material.create!(name: 'polyéthylène', climate_impact: 0.660, water_impact: 0.016, air_impact: 2.900)
# , climate_impact: , water_impact: , air_impact: )
polylactide = Material.create!(name: 'polylactide', climate_impact: 0.700, water_impact: 0.031, air_impact: 4.800)
# , climate_impact: , water_impact: , air_impact: )
polypropylene = Material.create!(name: 'polypropylène', climate_impact: 0.660, water_impact: 0.016, air_impact: 2.900)
# , climate_impact: , water_impact: , air_impact: )
polyuréthane = Material.create!(name: 'polyuréthane', climate_impact: 2.000, water_impact: 10.015, air_impact: 13.000)
# , climate_impact: , water_impact: , air_impact: )
viscose = Material.create!(name: 'viscose', climate_impact: 0.440, water_impact: 0.024, air_impact: 7.800)
# , climate_impact: , water_impact: , air_impact: )
