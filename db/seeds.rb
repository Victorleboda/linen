...
angora = Material.create!(name: 'angora', climate_impact: 10, water_impact: 10, air_impact: 10)
# , climate_impact: , water_impact: , air_impact: )
cachemire = Material.create!(name: 'cachemire', climate_impact: 10, water_impact: 10, air_impact: 10)
# , climate_impact: , water_impact: , air_impact: )
chanvre = Material.create!(name: 'chanvre', climate_impact: 10, water_impact: 10, air_impact: 10)
# , climate_impact: , water_impact: , air_impact: )
coton = Material.create!(name: 'coton', climate_impact: 10, water_impact: 10, air_impact: 10)
jute = Material.create!(name: 'jute')
# , climate_impact: , water_impact: , air_impact: )
laine_de_chameau = Material.create!(name: 'laine de chameau', climate_impact: 10, water_impact: 10, air_impact: 10)
# , climate_impact: , water_impact: , air_impact: )
...
laine_de_mouton = Material.create!(name: 'laine de mouton', climate_impact: 10, water_impact: 10, air_impact: 10)
# , climate_impact: , water_impact: , air_impact: )
lin = Material.create!(name: 'lin (étoupe)', climate_impact: 10, water_impact: 10, air_impact: 10)
# , climate_impact: , water_impact: , air_impact: )
lin2 = Material.create!(name: 'lin (filasse)', climate_impact: 10, water_impact: 10, air_impact: 10)
# , climate_impact: , water_impact: , air_impact: )
soie = Material.create!(name: 'soie', climate_impact: 10, water_impact: 10, air_impact: 10)
# , climate_impact: , water_impact: , air_impact: )
...
# , climate_impact: , water_impact: , air_impact: )
aramide = Material.create!(name: 'aramide', climate_impact: 10, water_impact: 10, air_impact: 10)
# , climate_impact: , water_impact: , air_impact: )
polyamide = Material.create!(name: "polyamide 66", climate_impact: 10, water_impact: 10, air_impact: 10)
# , climate_impact: , water_impact: , air_impact: )
pokyester = Material.create!(name: 'polyester', climate_impact: 10, water_impact: 10, air_impact: 10)
# , climate_impact: , water_impact: , air_impact: )
polyethykene = Material.create!(name: 'polyéthylène', climate_impact: 10, water_impact: 10, air_impact: 10)
# , climate_impact: , water_impact: , air_impact: )
polylactide = Material.create!(name: 'polylactide', climate_impact: 10, water_impact: 10, air_impact: 10)
# , climate_impact: , water_impact: , air_impact: )
polypropylene = Material.create!(name: 'polypropylène', climate_impact: 10, water_impact: 10, air_impact: 10)
# , climate_impact: , water_impact: , air_impact: )
polyuréthane = Material.create!(name: 'polyuréthane', climate_impact: 10, water_impact: 10, air_impact: 10)
# , climate_impact: , water_impact: , air_impact: )
viscose = Material.create!(name: 'viscose', climate_impact: 10, water_impact: 10, air_impact: 10)
# , climate_impact: , water_impact: , air_impact: )
