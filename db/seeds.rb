...
# , climate_impact: , water_impact: , air_impact: )
laine = Material.create(name: "laine de mouton", climate_impact: 9, water_impact: 6, air_impact: 8)
laine_mohair = Material.create(name: "laine de mouton", climate_impact: 9, water_impact: 6, air_impact: 9)
